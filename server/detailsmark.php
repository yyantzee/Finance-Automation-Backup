            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <a href="resolved.php"><button type="button" class="btn bg-red-600 hover:bg-red-700 text-white">Back</button></a>
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <div class="row mt-2">
                            <div class="col-md-12 mb-2"><label class="labels">IP Address</label><input disabled type="text" class="form-control" placeholder="first name" value="<?php echo $data["ip_address"]; ?>"></div>
                        </div>
                        <div class="row mt-2">
                            ...
                            <div class="col-md-6"><label class="labels">Last Name</label><input disabled type="text" class="form-control" value="<?php echo $data["last_name"]; ?>" placeholder="last_name"></div>
                        </div>
                        <div class="row mt-3">
