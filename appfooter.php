           ...
           <div class="m-auto md:w-10/12 lg:w-8/12 xl:w-6/12">
               <div class="flex flex-wrap items-center justify-between md:flex-nowrap">
                   ...
                   <div class="m-auto mt-16 w-10/12 space-y-6 text-center sm:mt-auto sm:w-5/12 sm:text-left">
                       <span class="block text-gray-500 dark:text-gray-400">Transforming Your Business, One Smart Step at a Time</span>

                       <span class="block text-gray-500 dark:text-gray-400">financeautomation.id &copy; <span id="year"></span></span>

                       <span class="block text-gray-500 dark:text-gray-400">Need help? <a href="./server/form.php" class="font-semibold text-blue-600"> Contact Us</a></span>
                   </div>
               </div>
           </div>
       </div>
